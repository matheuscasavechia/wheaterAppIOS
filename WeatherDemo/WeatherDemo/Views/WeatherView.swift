    ...
    var body: some View {
        ZStack(alignment: .leading){
            VStack{
                ...
                VStack{
                    HStack{
                        ...
                        Text(weather.main.feelsLike.roundDouble() + "º").font(.system(size: 60)).fontWeight(.bold).padding()
                    }
            ...
            VStack{
                ...
                .padding()
                .padding(.bottom, 20)
                .foregroundColor(Color(hue: 0.636, saturation: 0.693, brightness: 0.593))
                .background(.white)
